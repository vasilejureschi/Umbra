...
import org.unchiujar.umbra2.backend.LocationRecorder;
import org.unchiujar.umbra2.io.GpxExporter;
...
public class ExportDataPreference extends Preference {
    ...
    private class Importer extends AsyncTask<Void, Integer, Long> {
        ...
        protected void onPostExecute(Long result) {
            ...
            String exportPlace = "Data exported to " + exported.getAbsolutePath();


            AlertDialog.Builder builder = new AlertDialog.Builder(mContext).setCancelable(true)
                    .setIcon(android.R.drawable.ic_dialog_info).setMessage(exportPlace + " Do you want to share or send the exported file ?")
