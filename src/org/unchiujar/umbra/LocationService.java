...
public class LocationService extends Service {
    ...
    /** Flag signaling we have a fix and the location taken through the GPS is updated at a slow rate. */
    private boolean mGPSSlowMode;
    /** Flag signaling we have a GPS fix. If we  don't have a GPS fix (is false) and the GPS slow
     * mode is active than we have lost the GPS signal and need to get the location through the
     * network until a GPS fix is reestablished.
     */
    ...
    private LocationListener mCoarse = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            ...
            mLocationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 2 * 60 * 1000,
                    500,
                    mCoarse);
    ...
    private void doFastLocationFix() {
        ...
        mLocationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 500, 500, mCoarse);
